...
class ContrailProject(contrail.ContrailResource):
    ...
    properties_schema = {
        ...
        QUOTA: properties.Schema(
            ...
            schema={
                ...
                QUOTA_APPLICATION_POLICY_SET: properties.Schema(
                    properties.Schema.INTEGER,
                    _('QUOTA_APPLICATION_POLICY_SET.'),
                    update_allowed=True,
                    required=False,
                ),
    ...
    def handle_create(self):
        ...
        if self.properties.get(self.QUOTA) is not None:
            ...
            if self.properties.get(self.QUOTA, {}).get(self.QUOTA_APPLICATION_POLICY_SET) is not None:
                obj_1.set_application_policy_set(self.properties.get(self.QUOTA, {}).get(self.QUOTA_APPLICATION_POLICY_SET))
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        ...
        if prop_diff.get(self.QUOTA) is not None:
            ...
            if prop_diff.get(self.QUOTA, {}).get(self.QUOTA_APPLICATION_POLICY_SET) is not None:
                obj_1.set_application_policy_set(prop_diff.get(self.QUOTA, {}).get(self.QUOTA_APPLICATION_POLICY_SET))
